...
router.get('/offers/:id/responses', async (req, res) => {
  try {
    const { id: offerID } = req.params;
...
// Get response counts for multiple offers
router.post('/offers/response-counts', async (req, res) => {
  try {
...
// Get response counts for multiple requests
router.post('/requests/response-counts', async (req, res) => {
  try {
